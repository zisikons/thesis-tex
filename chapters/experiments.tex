...
\begin{wrapfigure}{r}{0.4\textwidth}
	%\centering
	\input{plots/experiments/trivial_rbf/phase_plain.tex}
	\captionsetup{format=plain}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	%\centering
	\input{plots/experiments/mimoRBF/3d_ref.tex}
	\captionsetup{format=plain}
...
\begin{figure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/mimoRBF/w_phi1.tex}
		%\caption{$\hat{W}_\varphi(t)$}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/mimoRBF/w_phi2.tex}
		%\caption{$\hat{W}_\gamma(t)$)}
	\end{subfigure}
...
\begin{figure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/mimoRBF/w_gamma11.tex}
		%\caption{$\hat{W}_\varphi(t)$}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/mimoRBF/w_gamma12.tex}
		%\caption{$\hat{W}_\gamma(t)$)}
	\end{subfigure}
...
\begin{figure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/mimoRBF/w_gamma21.tex}
		%\caption{$\hat{W}_\varphi(t)$}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/mimoRBF/w_gamma22.tex}
		%\caption{$\hat{W}_\gamma(t)$)}
	\end{subfigure}
...
{\begin{wraptable}[16]{r}{0.3\textwidth}
	...
	\begin{figure}
		\begin{subfigure}{0.5\textwidth}
			\input{plots/experiments/wing_rock/w_phi.tex}
			%\caption{$\hat{W}_\varphi(t)$}
		\end{subfigure}
		\begin{subfigure}{0.5\textwidth}
			\input{plots/experiments/wing_rock/w_gamma.tex}
			%\caption{$\hat{W}_\gamma(t)$)}
		\end{subfigure}
...
\begin{figure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/vdp/w_phi.tex}
		%\caption{$\hat{W}_\varphi(t)$}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/vdp/w_gamma.tex}
		%\caption{$\hat{W}_\gamma(t)$)}
	\end{subfigure}
	\caption{ Χρονική εξέλιξη των βαρών $\hat{W}_\varphi(t)$ (αριστερά) και της σταθεράς $\hat{w}_{\gamma 0}(t)$ (δεξιά) συναρτήσει του χρόνου.}
...
\begin{figure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/2dof/w_phi1.tex}
		%\caption{$\hat{W}_\varphi(t)$}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		\input{plots/experiments/2dof/w_gamma11.tex}
		%\caption{$\hat{W}_\gamma(t)$)}
	\end{subfigure}
